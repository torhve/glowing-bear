...
describe('Protocol buffer line parsing', () => {
  it('parses hdata buffer path with pointer', () => {
    ...
    it('parses timestamp correctly from time object', () => {
...
describe('Protocol nicklist parsing', () => {
    it('parses nicklist count and entries', () => {
...
describe('Protocol hotlist parsing', () => {
    it('parses hotlist with buffer pointer, message count, and buffer name', () => {
