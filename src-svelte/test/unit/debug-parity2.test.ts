...
describe('debug parity 2', () => {
    ...
    it('\x1a*bold\x1b/unbold text', async () => {
        ...
        for (let i = 0; i < Math.max(newResult.length, oldResult.length); i++) {
            ...
            console.log(`  texts match:`, n.text === o.text);
            console.log(`  fgColor match:`, JSON.stringify(n.fgColor) === JSON.stringify(o.fgColor));
            console.log(`  bgColor match:`, JSON.stringify(n.bgColor) === JSON.stringify(o.bgColor));
            console.log(`  attrs.name:`, n.attrs.name, 'vs', o.attrs.name);
            console.log(`  attrs.override keys:`, [...Object.keys(n.attrs.override)], 'vs', [...Object.keys(o.attrs.override)]);
        }
        expect(true).toBe(true);
    });

    it('\x1a*bold\x1creset', async () => {
        expect(OldProtocol).not.toBeNull();
