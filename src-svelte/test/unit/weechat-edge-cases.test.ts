...
describe('Protocol array parsing', () => {
    it('parses array of strings (tags)', () => {
...
describe('Protocol edge cases', () => {
    it('handles callback ID with hyphens', () => {
    ...
    it('handles single-byte char values', () => {
    ...
    it('handles buffer pointer strings with full IRC path', () => {
    ...
    it('handles negative integer values', () => {
